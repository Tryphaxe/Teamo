...
export const submitForm = async ({
	...
	setLoading(true);
	const toastVac = toast.loading("Enregistrement en cours...");
	...
	try {
		...
		toast.success(successMessage, { id: toastVac });
		...
		toast.error(message, { id: toastVac });
...
export const deleteVacance = async (id, reload = null) => {
	...
	const toastVac = toast.loading("Suppression en cours...");

	try {
		await axios.delete(`/api/vacances/${id}`);
		toast.success("Vacance supprimée avec succès.", { id: toastVac });
